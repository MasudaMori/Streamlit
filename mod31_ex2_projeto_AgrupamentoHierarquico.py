...
def main():
    ...
    st.sidebar.markdown('''
                        ...
                        **Por:** [Daniel Mori Masuda]<br>
                        **Data:** 22 de Outubro de 2024.<br>
    ...
    with st.echo():
        ...
        df = pd.read_csv('https://raw.githubusercontent.com/MasudaMori/Streamlit/refs/heads/main/online_shoppers_intention.csv')
